...
function BrowseEventsPage() {
    ...
    useEffect(() => {
        const fetchPublicEvents = async () => {
            try {
                // This endpoint returns Public events AND Dept events
    ...
    const handleRegisterMe = async (eventId) => {
        setRegisterStatus(prev => ({ ...prev, [eventId]: { message: 'Registering...', isError: false, loading: true } }));
        ...
        try {
            ...
            // Optimistically update the event list to show "Registered"
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2">Discover workshops, hackathons, and seminars.</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredEvents.length === 0 ? (
                        ...
                        filteredEvents.map((event) => {
                            ...
                            const isPast = eventDate < today; // True only if date is yesterday or earlier
                            // ----------------------

                            return (
                                <Card key={event._id} className="flex flex-col transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border-slate-200 dark:border-slate-800">
                                    <CardHeader>
                                    ...
                                    <CardFooter className="pt-2">
                                        {event.isRegistered ? (
                                            <Button disabled variant="secondary" className="w-full bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 opacity-100">
